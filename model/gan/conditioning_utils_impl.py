...
def _one_hot_to_embedding(one_hot, embedding_size):
  ...
  return embedding_ops.embedding_lookup(
      embedding, label_id, name='token_to_embedding'), embedding
...
def condition_tensor_from_onehot(tensor, one_hot_labels, embedding_size=256):
  ...
  conditioning, embedding_matrix = _one_hot_to_embedding(one_hot_labels, embedding_size)
  return condition_tensor(tensor, conditioning), embedding_matrix
