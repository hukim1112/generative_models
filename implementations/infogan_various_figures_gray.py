...
from models.gan import info_gan_64x64_gray as gan_networks
...
def load_batch(dataset_path, dataset_name, split_name, batch_size=128, image_size=[64, 64, 3]):
	...
	image = tf.image.rgb_to_grayscale(image) # convert image into grayscale image
...
def train(checkpoint_path, dataset_path, batch_size, result_path):
	...
	with tf.Graph().as_default():
		...
		dataset, images, labels = load_batch(dataset_path, 'figures', 'train', batch_size=batch_size, image_size=[64, 64, 1])
